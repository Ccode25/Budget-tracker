...
export function BudgetForm({ open, onOpenChange, onSubmit }: BudgetFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input id="bgt-name" placeholder="e.g. Monthly Living" {...register("name")} />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="bgt-limit">Limit ($)</Label>
              <Input id="bgt-limit" type="number" {...register("totalLimit", { valueAsNumber: true })} />
              {errors.totalLimit && (
