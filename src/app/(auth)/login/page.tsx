    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-muted/30 to-background py-12 px-4 sm:px-6 lg:px-8">
      <Container className="max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-foreground mt-4">Welcome</h1>
          <p className="text-sm text-muted-foreground">Sign in to manage your budgets and finances.</p>
        </div>
        ...
        <Card className="border-border shadow-xl backdrop-blur-sm bg-card/95">
          <CardHeader className="space-y-1 pb-4 text-center">
            ...
            <CardDescription>Fast, secure single sign-on with your Google Account</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-2 text-center text-xs text-muted-foreground flex items-center justify-center gap-1.5">
              ...
              <span>No password required — automatic account setup</span>
            </div>
          </CardContent>
        </Card>
      </Container>
